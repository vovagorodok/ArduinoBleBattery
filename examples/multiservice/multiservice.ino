...
#include <ArduinoBleBatteryMultiservice.h>
...
#ifdef BLE_BATTERY_LIB_NIM_BLE_ARDUINO
...
void setup() {
  ...
  ArduinoBleBattery.begin(batteryService);
  advertiseBle(NAME, BLE_BATTERY_SERVICE_UUID, LED_SERVICE_UUID);
#endif
  ...
  ledService->start();
  ArduinoBleBattery.begin(server, batteryService);
  advertiseBle(server, NAME, BLE_BATTERY_SERVICE_UUID, LED_SERVICE_UUID);
#endif
}
